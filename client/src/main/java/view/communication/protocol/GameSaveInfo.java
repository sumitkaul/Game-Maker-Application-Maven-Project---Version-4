...
public class GameSaveInfo {
    ...
    public GameSaveInfo(String saveName, String gameName, String gamePlayer, int id,int gameScore) {
        this.saveName = saveName;
        this.gameName = gameName;
        this.gamePlayer = gamePlayer;
        this.id = id;
    ...
    public GameSaveInfo(String saveName, String gameName, String gamePlayer, int gameScore, int rank, String gameData) {
        this.saveName = saveName;
        this.gameName = gameName;
        this.gamePlayer = gamePlayer;
        this.gameScore = gameScore;
